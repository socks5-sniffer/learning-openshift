...
export default function Module12() {
  return (
    <ModuleShell id="1-2" subtitle="The Brains of the Operation">
      ...
      <section className={styles.spotlight}>
        ...
        <div className={moduleStyles.grid}>
          <Callout variant="danger" icon="🚪" title="API Server">
            <p><strong>The Front Door</strong></p>
            <p>The main entry point to the cluster. All requests go through here.</p>
          </Callout>

          <Callout variant="warning" icon="🗄️" title="etcd">
            <p><strong>The Database</strong></p>
            <p>Stores all cluster data. Where hope and fear are stored.</p>
          </Callout>

          <Callout variant="info" icon="📋" title="Scheduler">
            <p><strong>The Matchmaker</strong></p>
            <p>Assigns new pods to worker nodes based on resources.</p>
          </Callout>

          <Callout variant="success" icon="⚙️" title="Controller Manager">
            <p><strong>The Caretaker</strong></p>
            <p>Monitors cluster state and makes corrections when needed.</p>
          </Callout>
        </div>
      </section>
      ...
      <section className={styles.spotlight}>
        ...
        <Callout variant="warning" icon="🔑" title="Key Point">
          <p>
      ...
      <section className={styles.spotlight}>
        ...
        <div style={{ marginLeft: '20px' }}>
          <h4 style={{ color: 'var(--color-text-accent)' }}>Node Controller</h4>
          <ul>
          ...
          <h4 style={{ color: 'var(--color-text-accent)' }}>Replication Controller</h4>
          <ul>
          ...
          <h4 style={{ color: 'var(--color-text-accent)' }}>Endpoints Controller</h4>
          <ul>
            <li>Populates endpoint objects (links Services to Pods)</li>
            <li>Updates endpoints when pods come and go</li>
          </ul>

          <h4 style={{ color: 'var(--color-text-accent)' }}>Service Account &amp; Token Controllers</h4>
          <ul>
      ...
      <section className={styles.spotlight}>
        ...
        <Callout variant="neutral" title="Scenario: kubectl create deployment nginx --image=nginx --replicas=3">
