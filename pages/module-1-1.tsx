...
export default function Module11() {
  return (
    <ModuleShell id="1-1" subtitle="Understanding the Foundation">
      ...
      <section className={styles.spotlight}>
        ...
        <div className={moduleStyles.grid}>
          <Callout variant="danger" icon="🧠" title="Control Plane Nodes">
            <p><strong>The brain of the cluster</strong></p>
            <ul>
          ...
          <Callout variant="info" icon="💪" title="Worker Nodes">
            <p><strong>The muscle of the cluster</strong></p>
            <ul>
      ...
      <section className={styles.spotlight}>
        ...
        <Callout variant="info" icon="💡" title="Important Distinction">
          <p>
      ...
      <section className={styles.spotlight}>
        ...
        <Callout variant="info" icon="💡" title="Pro Tip">
          <p>
