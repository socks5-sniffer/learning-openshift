  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>Module 8.1: Logging</h1>
        ...
        <div style={{ marginBottom: '2rem' }}>
          ...
          <span style={{ margin: '0 1rem', color: '#64748b' }}>|</span>
          <Link href="/module-8-2" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '1.1rem' }}>Next: Monitoring →</Link>
        </div>
...
`}</pre>
        ...
        <div style={{
          ...
          <Link href="/module-7-3" style={{
            ...
            }}>← Previous: Network Policies</Link>
