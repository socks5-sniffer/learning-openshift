    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          <Link href="/module-3-3" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '1.1rem' }}>← Previous: Environment Strategy</Link>
          <span style={{ margin: '0 1rem', color: '#64748b' }}>|</span>
          <Link href="/learning-modules" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '1.1rem' }}>All Modules</Link>
          <span style={{ margin: '0 1rem', color: '#64748b' }}>|</span>
          <Link href="/module-4-2" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '1.1rem' }}>Next: Node Scheduling →</Link>
        </div>
        ...
        <div style={{
          ...
          <Link href="/module-3-3" style={{
            ...
            }}>← Previous: Environment Strategy</Link>
