    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        <div style={{ marginBottom: '2rem' }}>
          <Link href="/module-2-2" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '1.1rem' }}>← Previous: ReplicaSets & Deployments</Link>
          <span style={{ margin: '0 1rem', color: '#64748b' }}>|</span>
          <Link href="/learning-modules" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '1.1rem' }}>All Modules</Link>
          <span style={{ margin: '0 1rem', color: '#64748b' }}>|</span>
          <Link href="/module-3-1" style={{ color: '#94a3b8', textDecoration: 'none', fontSize: '1.1rem' }}>Next: ConfigMaps →</Link>
        </div>
        ...
        <div style={{
          ...
          <Link href="/module-2-2" style={{
            ...
            }}>← Previous: ReplicaSets & Deployments</Link>
