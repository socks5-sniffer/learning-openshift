...
export default function Module23() {
  ...
  return (
    <ModuleShell id="2-3" subtitle="Networking Without Tears">
          ...
          <div style={{ marginBottom: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '20px' }}>
              {pods.map((pod) => (
                ...
                >
                  ...
                  <div style={{ fontSize: '0.9rem', marginTop: '8px' }}>IP: {pod.ip}</div>
                  {!pod.healthy && <div style={{ fontSize: '0.8rem', marginTop: '4px' }}>⚠️ Crashed</div>}
                </div>
              ))}
            </div>
            ...
            <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
              <button
                ...
                style={{
                  padding: '12px 24px',
                  background: simulationRunning ? 'var(--color-bg-tertiary)' : 'var(--color-primary)',
                  color: '#fff',
                  border: 'none',
                  borderRadius: 'var(--radius-md)',
      ...
      <section className={styles.spotlight}>
        ...
        <Callout variant="neutral" title="How Matching Works">
      ...
      <section className={styles.spotlight}>
        ...
        <p>Kubernetes has four main Service types, each designed for different use cases:</p>

        <h3>1. ClusterIP (Default)</h3>
        <Callout variant="info" title="Internal Cluster Networking">
        ...
        <h3>2. NodePort</h3>
        <Callout variant="warning" title="Expose on Node IPs">
        ...
        <Callout variant="success" title="Cloud Provider Load Balancer">
        ...
        <Callout variant="neutral" title="DNS Alias (Advanced)">
      ...
      <section className={styles.spotlight}>
        ...
        <Callout variant="neutral" title="Scenario">
      ...
      <section className={styles.spotlight}>
        ...
        <div className={moduleStyles.grid}>
          <Callout variant="success" title="LoadBalancer Service">
            <ul>
          ...
          <Callout variant="info" title="Ingress">
            <ul>
